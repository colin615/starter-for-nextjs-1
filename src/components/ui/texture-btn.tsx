...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      ...
      secondary:
        "w-full border-[1px] dark:border-[1px] border-black/20 bg-white/50 dark:border-neutral-950 dark:bg-neutral-600/50 p-[1px] transition duration-300 ease-in-out ",
      minimal:
  ...
  "w-full h-full flex items-center justify-center text-muted-foreground cursor-pointer font-[500]",
  {
    variants: {
      variant: {
        ...
        accent:
          "gap-2 bg-gradient-to-tr to-[#066FE6] from-[##5890E2] text-sm text-white/90 transition duration-300 ease-in-out hover:bg-gradient-to-b hover:from-indigo-400/70 hover:to-indigo-600/70 dark:hover:from-indigo-400/70 dark:hover:to-indigo-600/70 active:bg-gradient-to-b active:from-indigo-400/80 active:to-indigo-600/80 dark:active:from-indigo-400 dark:active:to-indigo-600",
        destructive:
      ...
      size: {
        ...
        default: "text-sm rounded-[5px] px-4 py-2",
        lg: "text-base rounded-[10px] px-4 py-2",
        icon: "rounded-[4px] p-1",
      },
    },
    defaultVariants: {
      variant: "primary",
